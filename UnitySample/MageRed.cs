...
public class MageRed : MonoBehaviourPun
{
    ...
    IEnumerator CheckMonsterState()
    {
        while(isDie == false)
        {
            ...
            if(playerTr)
            {
                ...
                if (playerTr.gameObject.CompareTag("BLUE"))
                {
                    if (playerTr.gameObject.GetComponent<MageBlue>() != null)
                    {
                        if (playerTr.gameObject.GetComponent<MageBlue>().isDie)
                        {
                            {
            ...
            else
            {
                ...
                for(int i = 0; i < colliders.Length; i++)
                {
                    ...
                    else if (colliders[i].CompareTag("BLUE"))
                    {
                        Debug.Log("인식");
                        playerTr = colliders[i].GetComponent<Transform>();
                        break;
    ...
    {
        if (other.gameObject.CompareTag("BLUESTAFF"))
        {
